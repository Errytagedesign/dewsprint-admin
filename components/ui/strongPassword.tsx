      ...
      <ul className="mb-3 grid grid-cols-2 gap-1 text-xs lg:grid-cols-4">
        <li
          className={`flex items-center gap-2 ${
            password.length >= 8 ? "text-success-500" : "text-Grey-400"
          }`}
        >
        ...
        <li
          className={`flex items-center gap-2 ${
            isSpecialChars ? "text-success-500" : "text-Grey-400"
          }`}
        >
          <FaRegCircleCheck />
          Special character
        ...
        <li
          className={`flex items-center gap-2 ${
            isUppercase ? "text-success-500" : "text-Grey-400"
          }`}
        >
        ...
        <li
          className={`flex items-center gap-2 ${
            isNumber ? "text-success-500" : "text-Grey-400"
          }`}
        >
